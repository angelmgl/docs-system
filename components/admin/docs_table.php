<table class="business-table">
    ...
    <tbody>
        ...
        foreach ($docs as $doc) { 
            $doc_type = null;
            $view_url = BASE_URL . "/admin/contenido/documentos/";
            $edit_url = BASE_URL . "/admin/contenido/documentos/";
            $delete_url = BASE_URL . "/admin/contenido/documentos/delete.php?document_id=" . $doc["id"] . "&doc_type=" . $doc["type"];
            ...
            <tr>
                ...
                <td class="actions-column">
                    <div class="table-actions">
                        <a target="_blank" href="<?php echo $view_url; ?>" class="action view">
