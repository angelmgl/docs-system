...
if (isset($_FILES['csv_file'])) {
    ...
    if ($file_extension != 'csv') {
        handle_form_error("Error: Archivo no válido", array(), "/business/usuarios/block.php");
    } else {
    ...
    handle_form_error("Error: No se recibió ningún archivo", array(), "/business/usuarios/block.php");
}
