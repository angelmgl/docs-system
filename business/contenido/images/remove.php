...
<body>
    ...
    <main class="container px py content" id="remove-image">
        ...
        <div class="remove-actions">
            ...
            <a href="<?php echo BASE_URL ?>/business/contenido/documentos/edit_image.php?document_id=<?php echo $image["document_id"] ?>" class="btn btn-secondary">No, cancelar</a>
        </div>
    </main>
</body>
