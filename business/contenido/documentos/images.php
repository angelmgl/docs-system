    ...
    <main class="container py px">
        <div class="admin-bar">
            <div>
                ...
                <div class="document-title">
                    ...
                    <a href="<?php echo BASE_URL . "/business/contenido/documentos/" . "edit_image.php?document_id=" . $document["id"] ?>">
        ...
        <section class="photo-grid" id="gallery">
            <?php if (isset($document['images']) && !empty($document['images'])) : ?>
                ...
                <?php endforeach; ?>
                <?php if($_SESSION["role"] === "admin") { ?>
                <a class="add-image" href="<?php echo BASE_URL . "/business/contenido/documentos/" . "edit_image.php?document_id=" . $document["id"] ?>">
