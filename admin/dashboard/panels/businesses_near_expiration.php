...
$sql = "SELECT * FROM businesses WHERE expiration_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 7 DAY)";
...
<div class="panel">
    <h2>Suscripciones que acaban esta semana</h2>
            ...
            <div class="my-business-card" style="margin-bottom: 10px;">
                ...
                <div class="my-business-content">
                    ...
                    <p style="margin: 8px 0;" class="my-business-role">
                        ...
                        Expira el <?php echo format_date($business['expiration_date'], false) ?>
                    </p>
