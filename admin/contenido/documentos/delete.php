...
if ($document === null) {
    header("Location: " . BASE_URL . "/admin/contenido/categorias/?category_id=" . $document["category_id"]);
    exit;
}
...
<body>
    ...
    <main class="container px py content" id="remove-user">
        ...
        <div class="remove-actions">
            ...
            <a href="<?php echo BASE_URL . "/admin/contenido/categorias/?category_id=" . $document["category_id"]?>" class="btn btn-secondary">No, cancelar</a>
        </div>
    </main>
</body>
