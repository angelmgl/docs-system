                    ...
                    <?php foreach ($adminsAndAnalysts as $admin) { ?>
                        <div class="admin-card">
                            ...
                            <div class="admin-actions">
                                <a 
                                    href="<?php echo BASE_URL ?>/admin/empresas/edit-user.php?business_id=<?php echo $business["id"]; ?>&user_id=<?php echo $admin["id"]; ?>" 
                                    class="action edit"
                                >
                                ...
                                <a 
                                    href="<?php echo BASE_URL ?>/admin/empresas/delete-user.php?business_id=<?php echo $business["id"]; ?>&user_id=<?php echo $admin["id"]; ?>" 
                                    class="action delete"
                                >
